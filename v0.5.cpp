...
int main()
{
    ...
    if (konteineris == 1)
    {
        ...
        if (ats4 == "Taip")
        {
            ...
            cout << "Failo (studentai" + to_string(z) + ".txt) suriuoti studentai buvo isvesti i naujus failus (kietuoliai.txt) ir (vargsiuokai.txt) per:  " << diff4.count() << " sekundes" << endl;
    ...
    if (konteineris == 2)
    {
        ...
        if (ats4 == "Taip")
        {
            ...
            for (int i = 0; i < vsum; i++)
            {
                out << setw(20) << left << Vargsiukai1.front().pavarde << setw(20) << left << Vargsiukai1.front().vardas << setw(19) << fixed << setprecision(0) << ((Vargsiukai1.front().ndsum / nd) * 0.4) + Vargsiukai1.front().egz * 0.6 << endl;
            ...
            for (int i = 0; i < ksum; i++)
            {
                out1 << setw(20) << left << Kietuoliai1.front().pavarde << setw(20) << left << Kietuoliai1.front().vardas << setw(19) << fixed << setprecision(0) << ((Kietuoliai1.front().ndsum / nd) * 0.4) + Kietuoliai1.front().egz * 0.6 << endl;
            ...
            cout << "Failo (studentai" + to_string(z) + ".txt) suriuoti studentai buvo isvesti i naujus failus (kietuoliai.txt) ir (vargsiuokai.txt) per:  " << diff8.count() << " sekundes" << endl;
        ...
        if (ats4 == "Ne")
        {
            ...
            for (int i = 0; i < k; i++)
            {
                cout << setw(20) << left << Studentai1.front().pavarde << setw(20) << left << Studentai1.front().vardas << setw(19) << fixed << setprecision(0) << (Studentai1.front().ndsum / nd) * 0.4 + Studentai1.front().egz * 0.6 << endl;
            }
    ...
    if (konteineris == 3)
    {
        ...
        if (ats4 == "Taip")
        {
            ...
            for (int i = 0; i < vsum; i++)
            {
                out << setw(20) << left << Vargsiukai2.front().pavarde << setw(20) << left << Vargsiukai2.front().vardas << setw(19) << fixed << setprecision(0) << ((Vargsiukai2.front().ndsum / nd) * 0.4) + Vargsiukai2.front().egz * 0.6 << endl;
            ...
            for (int i = 0; i < ksum; i++)
            {
                out1 << setw(20) << left << Kietuoliai2.front().pavarde << setw(20) << left << Kietuoliai2.front().vardas << setw(19) << fixed << setprecision(0) << ((Kietuoliai2.front().ndsum / nd) * 0.4) + Kietuoliai2.front().egz * 0.6 << endl;
        ...
        if (ats4 == "Ne")
        {
            ...
            for (int i = 0; i < k; i++)
            {
                cout << setw(20) << left << Studentai2.front().pavarde << setw(20) << left << Studentai2.front().vardas << setw(19) << fixed << setprecision(0) << (Studentai2.front().ndsum / nd) * 0.4 + Studentai2.front().egz * 0.6 << endl;
            }
