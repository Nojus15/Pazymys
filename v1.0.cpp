    ...
    if (konteineris == 2)
    {
        ...
        if (rusiavimas == 2)
        {
            ...
            if (ats4 == "Taip")
            {
                ...
                StudentuSkirstymasPagalVidurki4(Studentai1, Vargsiukai1);
    ...
    if (konteineris == 3)
    {
        ...
        if (rusiavimas == 2)
        {
            ...
            if (ats4 == "Taip")
            {
                ...
                auto start7 = system_clock::now();
                StudentuSkirstymasPagalVidurki5(Studentai2, Vargsiukai2);
                auto end7 = system_clock::now();
                duration<double> diff7 = end7 - start7;
                sort(Studentai2.begin(), Studentai2.end());
